...
/**
 * Interface indicating send report successfully.
 * @author Mengmeng Ai
 * @version 1.0
 */
public class SendSuccess extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SendSuccess frame = new SendSuccess();
	...
	public SendSuccess() {
		...
		JLabel lblpayment = new JLabel(">Send report");
		lblpayment.setForeground(new Color(255, 140, 0));
		lblpayment.setFont(new Font("Comic Sans MS", Font.BOLD | Font.ITALIC, 16));
		lblpayment.setBounds(14, 0, 109, 31);
		panel_1.add(lblpayment);
		
		JLabel lblYouHaveModified = new JLabel("Send report successfully !");
		...
		lblYouHaveModified.setBounds(49, 106, 354, 61);
